...
/* synthetic */ class j {
    ...
    static final /* synthetic */ int[] f3661a = new int[ImageView.ScaleType.values().length];

    /* renamed from: b  reason: collision with root package name */
    static final /* synthetic */ int[] f3662b = new int[h.values().length];
    ...
    static {
        /*
            c.a.a.h[] r0 = c.a.a.h.values()
            int r0 = r0.length
            int[] r0 = new int[r0]
            f3662b = r0
            r0 = 1
            int[] r1 = f3662b     // Catch:{ NoSuchFieldError -> 0x0014 }
            c.a.a.h r2 = c.a.a.h.LOW     // Catch:{ NoSuchFieldError -> 0x0014 }
            int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
            r1[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0014 }
        L_0x0014:
            r1 = 2
            int[] r2 = f3662b     // Catch:{ NoSuchFieldError -> 0x001f }
            c.a.a.h r3 = c.a.a.h.NORMAL     // Catch:{ NoSuchFieldError -> 0x001f }
            int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
            r2[r3] = r1     // Catch:{ NoSuchFieldError -> 0x001f }
        L_0x001f:
            r2 = 3
            int[] r3 = f3662b     // Catch:{ NoSuchFieldError -> 0x002a }
            c.a.a.h r4 = c.a.a.h.HIGH     // Catch:{ NoSuchFieldError -> 0x002a }
            int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
            r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
        L_0x002a:
            r3 = 4
            int[] r4 = f3662b     // Catch:{ NoSuchFieldError -> 0x0035 }
            c.a.a.h r5 = c.a.a.h.IMMEDIATE     // Catch:{ NoSuchFieldError -> 0x0035 }
        ...
        L_0x0035:
            ...
            int[] r4 = new int[r4]
            f3661a = r4
            int[] r4 = f3661a     // Catch:{ NoSuchFieldError -> 0x0048 }
        ...
        L_0x0048:
            int[] r0 = f3661a     // Catch:{ NoSuchFieldError -> 0x0052 }
        ...
        L_0x0052:
            int[] r0 = f3661a     // Catch:{ NoSuchFieldError -> 0x005c }
        ...
        L_0x005c:
            int[] r0 = f3661a     // Catch:{ NoSuchFieldError -> 0x0066 }
        ...
        L_0x0066:
            int[] r0 = f3661a     // Catch:{ NoSuchFieldError -> 0x0071 }
        ...
        L_0x0071:
            int[] r0 = f3661a     // Catch:{ NoSuchFieldError -> 0x007c }
        ...
        L_0x007c:
            int[] r0 = f3661a     // Catch:{ NoSuchFieldError -> 0x0087 }
        ...
        L_0x0087:
            int[] r0 = f3661a     // Catch:{ NoSuchFieldError -> 0x0093 }
        ...
        L_0x0093:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: c.a.a.j.<clinit>():void");
    }
}
