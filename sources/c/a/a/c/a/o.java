...
public class o extends m<InputStream> {
    ...
    private static final UriMatcher f2989d = new UriMatcher(-1);

    static {
        f2989d.addURI("com.android.contacts", "contacts/lookup/*/#", 1);
        f2989d.addURI("com.android.contacts", "contacts/lookup/*", 1);
        f2989d.addURI("com.android.contacts", "contacts/#/photo", 2);
        f2989d.addURI("com.android.contacts", "contacts/#", 3);
        f2989d.addURI("com.android.contacts", "contacts/#/display_photo", 4);
        f2989d.addURI("com.android.contacts", "phone_lookup/*", 5);
    }
