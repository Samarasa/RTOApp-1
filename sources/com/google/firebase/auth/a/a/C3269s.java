...
final class C3269s extends ba<C3278c, C3287c> {
    private final C3279d z;

    public C3269s(C3279d dVar) {
        super(2);
    ...
    public final /* synthetic */ void a(N n, j jVar) {
        ...
        C3279d dVar = this.z;
        dVar.a(this.f14305d);
        C0259ba baVar = new C0259ba(dVar);
        if (this.t) {
            n.a().a(baVar.a(), (T) this.f14303b);
        } else {
            n.a().a(baVar, (T) this.f14303b);
        }
    }
