...
public final class e {
    ...
    private static final AtomicInteger f14646a = new AtomicInteger((int) SystemClock.elapsedRealtime());
    ...
    private static PendingIntent a(Context context, Intent intent) {
        return PendingIntent.getBroadcast(context, f14646a.incrementAndGet(), new Intent("com.google.firebase.MESSAGING_EVENT").setComponent(new ComponentName(context, "com.google.firebase.iid.FirebaseInstanceIdReceiver")).putExtra("wrapped_intent", intent), 1073741824);
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:75:0x0266  */
    ...
    static com.google.firebase.messaging.d a(android.content.Context r9, com.google.firebase.messaging.q r10) {
        /*
            ...
            androidx.core.app.n$c r6 = new androidx.core.app.n$c
            r6.<init>()
            r6.a((java.lang.CharSequence) r2)
            r5.a((androidx.core.app.n.g) r6)
        L_0x0048:
        ...
        L_0x00ef:
            ...
            r3.putExtras(r2)
            java.util.concurrent.atomic.AtomicInteger r2 = f14646a
        ...
        L_0x02c0:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.messaging.e.a(android.content.Context, com.google.firebase.messaging.q):com.google.firebase.messaging.d");
    }

    private static CharSequence a(String str, q qVar, PackageManager packageManager, Resources resources) {
        String a2 = qVar.a(resources, str, "gcm.n.title");
    ...
    private static Integer a(Context context, String str, Bundle bundle) {
        ...
        if (i != 0) {
            try {
                return Integer.valueOf(a.a(context, i));
