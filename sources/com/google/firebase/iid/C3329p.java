...
final class C3329p {
    ...
    private final Executor f14588a;

    /* renamed from: b  reason: collision with root package name */
    private final Map<Pair<String, String>, i<C3314a>> f14589b = new b();

    C3329p(Executor executor) {
        this.f14588a = executor;
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ i a(Pair pair, i iVar) {
        synchronized (this) {
            this.f14589b.remove(pair);
        }
        return iVar;
    }
    ...
    public final synchronized c.b.b.b.g.i<com.google.firebase.iid.C3314a> a(java.lang.String r4, java.lang.String r5, com.google.firebase.iid.r r6) {
        /*
            r3 = this;
            monitor-enter(r3)
            android.util.Pair r0 = new android.util.Pair     // Catch:{ all -> 0x0081 }
            r0.<init>(r4, r5)     // Catch:{ all -> 0x0081 }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, c.b.b.b.g.i<com.google.firebase.iid.a>> r4 = r3.f14589b     // Catch:{ all -> 0x0081 }
            java.lang.Object r4 = r4.get(r0)     // Catch:{ all -> 0x0081 }
            c.b.b.b.g.i r4 = (c.b.b.b.g.i) r4     // Catch:{ all -> 0x0081 }
            r5 = 3
        ...
        L_0x006b:
            c.b.b.b.g.i r4 = r6.a()     // Catch:{ all -> 0x0081 }
            java.util.concurrent.Executor r5 = r3.f14588a     // Catch:{ all -> 0x0081 }
            com.google.firebase.iid.o r6 = new com.google.firebase.iid.o     // Catch:{ all -> 0x0081 }
            r6.<init>(r3, r0)     // Catch:{ all -> 0x0081 }
            c.b.b.b.g.i r4 = r4.b(r5, r6)     // Catch:{ all -> 0x0081 }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, c.b.b.b.g.i<com.google.firebase.iid.a>> r5 = r3.f14589b     // Catch:{ all -> 0x0081 }
        ...
        L_0x0081:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.C3329p.a(java.lang.String, java.lang.String, com.google.firebase.iid.r):c.b.b.b.g.i");
    }
}
