...
final /* synthetic */ class C3316c implements Runnable {

    /* renamed from: a  reason: collision with root package name */
    private final ca f14558a;
    ...
    public final void run() {
        /*
            r8 = this;
            com.google.firebase.iid.ca r0 = r8.f14558a
        L_0x0002:
            monitor-enter(r0)
            int r1 = r0.f14559a     // Catch:{ all -> 0x00ae }
            r2 = 2
            if (r1 == r2) goto L_0x000a
            monitor-exit(r0)     // Catch:{ all -> 0x00ae }
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.j<?>> r1 = r0.f14562d     // Catch:{ all -> 0x00ae }
        ...
        L_0x0017:
            ...
            com.google.firebase.iid.j r1 = (com.google.firebase.iid.C3323j) r1     // Catch:{ all -> 0x00ae }
            android.util.SparseArray<com.google.firebase.iid.j<?>> r3 = r0.f14563e     // Catch:{ all -> 0x00ae }
            int r4 = r1.f14575a     // Catch:{ all -> 0x00ae }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.ba r3 = r0.f14564f     // Catch:{ all -> 0x00ae }
            java.util.concurrent.ScheduledExecutorService r3 = r3.f14555c     // Catch:{ all -> 0x00ae }
        ...
        L_0x0066:
            com.google.firebase.iid.ba r3 = r0.f14564f
            android.content.Context r3 = r3.f14554b
            android.os.Messenger r4 = r0.f14560b
            ...
            r4.putString(r6, r3)
            android.os.Bundle r1 = r1.f14578d
            java.lang.String r3 = "data"
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.h r1 = r0.f14561c     // Catch:{ RemoteException -> 0x00a4 }
        ...
        L_0x00b2:
            goto L_0x00b1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.C3316c.run():void");
    }
}
