...
public final class D implements ServiceConnection {
    ...
    private D(Context context, String str, ScheduledExecutorService scheduledExecutorService) {
        this.f14495d = new ArrayDeque();
        this.f14497f = false;
        this.f14492a = context.getApplicationContext();
        this.f14493b = new Intent(str).setPackage(this.f14492a.getPackageName());
    ...
    private final synchronized void a() {
        ...
        L_0x0011:
            java.util.Queue<com.google.firebase.iid.G> r0 = r6.f14495d     // Catch:{ all -> 0x00ab }
            ...
            android.util.Log.d(r0, r2)     // Catch:{ all -> 0x00ab }
        L_0x0028:
            com.google.firebase.iid.B r0 = r6.f14496e     // Catch:{ all -> 0x00ab }
        ...
        L_0x0043:
            ...
            com.google.firebase.iid.B r2 = r6.f14496e     // Catch:{ all -> 0x00ab }
        ...
        L_0x0051:
            ...
            java.lang.String r0 = "FirebaseInstanceId"
            boolean r3 = r6.f14497f     // Catch:{ all -> 0x00ab }
        ...
        L_0x007a:
            boolean r0 = r6.f14497f     // Catch:{ all -> 0x00ab }
            if (r0 != 0) goto L_0x00a7
            r6.f14497f = r2     // Catch:{ all -> 0x00ab }
            com.google.android.gms.common.stats.a r0 = com.google.android.gms.common.stats.a.a()     // Catch:{ SecurityException -> 0x009a }
            android.content.Context r2 = r6.f14492a     // Catch:{ SecurityException -> 0x009a }
            android.content.Intent r3 = r6.f14493b     // Catch:{ SecurityException -> 0x009a }
            r4 = 65
        ...
        L_0x00a2:
            r6.f14497f = r1     // Catch:{ all -> 0x00ab }
    ...
    public final synchronized void a(Intent intent, BroadcastReceiver.PendingResult pendingResult) {
        ...
        this.f14495d.add(new G(intent, pendingResult, this.f14494c));
        a();
    }
