...
public enum Uoa implements C3076zea {
    ...
    private static final Cea<Uoa> W = null;
    private final int Y;
    ...
    public final String toString() {
        return "<" + Uoa.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.Y + " name=" + name() + '>';
    }
}
