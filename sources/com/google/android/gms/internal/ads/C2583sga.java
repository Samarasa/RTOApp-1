...
interface C2583sga {
    ...
    void a(int i, Lda lda);

    void a(int i, Object obj);

    @Deprecated
    void a(int i, Object obj, Cfa cfa);

    void a(int i, String str);

    void a(int i, List<Lda> list);

    void a(int i, List<?> list, Cfa cfa);

    void a(int i, List<Boolean> list, boolean z);
    ...
    void b(int i, Object obj, Cfa cfa);

    void b(int i, List<String> list);

    @Deprecated
    void b(int i, List<?> list, Cfa cfa);
    ...
    void g(int i, List<Integer> list, boolean z);
    ...
    void n(int i, List<Float> list, boolean z);
}
