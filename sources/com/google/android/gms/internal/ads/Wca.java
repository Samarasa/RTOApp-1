...
public final class Wca {
    ...
    public static KeyPair a(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator a2 = Zca.f9565h.a("EC");
        a2.initialize(eCParameterSpec);
        return a2.generateKeyPair();
    }

    public static ECPublicKey a(Yca yca, byte[] bArr, byte[] bArr2) {
        ECParameterSpec a2 = a(yca);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        a(eCPoint, a2.getCurve());
        return (ECPublicKey) Zca.i.a("EC").generatePublic(new ECPublicKeySpec(eCPoint, a2));
    }

    public static ECParameterSpec a(Yca yca) {
        String str;
        String str2;
        String str3;
        String str4;
        String str5;
        int i = Vca.f9059b[yca.ordinal()];
        if (i == 1) {
            ...
            String valueOf = String.valueOf(yca);
    ...
    public static byte[] a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) {
        ...
        PublicKey generatePublic = Zca.i.a("EC").generatePublic(new ECPublicKeySpec(eCPoint, eCPrivateKey.getParams()));
        KeyAgreement a2 = Zca.f9564g.a("ECDH");
            ...
            if (a3.signum() == 1) {
                ...
                if (mod2.equals(BigInteger.ZERO)) {
                    ...
                    if (a3.testBit(0) && a3.testBit(1)) {
                        ...
                        int i = 0;
                        while (true) {
                            BigInteger mod3 = bigInteger.multiply(bigInteger).subtract(mod2).mod(a3);
                            ...
                            if (modPow.add(BigInteger.ONE).equals(a3)) {
                                ...
                                for (int bitLength = shiftRight2.bitLength() - 2; bitLength >= 0; bitLength--) {
                                    ...
                                    if (shiftRight2.testBit(bitLength)) {
                                        BigInteger mod4 = bigInteger5.multiply(bigInteger).add(bigInteger4.multiply(mod3)).mod(a3);
                                        bigInteger4 = bigInteger.multiply(bigInteger4).add(bigInteger5).mod(a3);
                                        bigInteger5 = mod4;
                                    }
                                }
                    ...
                    if (bigInteger != null) {
                        if (bigInteger.multiply(bigInteger).mod(a3).compareTo(mod2) != 0) {
