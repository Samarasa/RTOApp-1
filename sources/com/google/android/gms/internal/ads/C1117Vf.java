...
public abstract class C1117Vf extends C2587sia implements C1039Sf {
    public C1117Vf() {
    ...
    public final boolean a(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) {
        ...
        L_0x0086:
            ...
            goto L_0x00aa
        L_0x008b:
            com.google.android.gms.internal.ads.lb r1 = r0.ra()
        L_0x008f:
            r3.writeNoException()
        ...
        L_0x00b0:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C1117Vf.a(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
