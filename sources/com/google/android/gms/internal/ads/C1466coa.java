...
public final class C1466coa extends Rna {

    /* renamed from: c  reason: collision with root package name */
    private MessageDigest f10086c;
    ...
    public C1466coa(int i) {
        int i2 = i / 8;
        this.f10087d = i % 8 > 0 ? i2 + 1 : i2;
        this.f10088e = i;
    }
    ...
    public final byte[] a(java.lang.String r9) {
        /*
            r8 = this;
            java.lang.Object r0 = r8.f8540b
            monitor-enter(r0)
            java.security.MessageDigest r1 = r8.a()     // Catch:{ all -> 0x006c }
            r8.f10086c = r1     // Catch:{ all -> 0x006c }
            java.security.MessageDigest r1 = r8.f10086c     // Catch:{ all -> 0x006c }
            r2 = 0
        ...
        L_0x0012:
            ...
            java.security.MessageDigest r9 = r8.f10086c     // Catch:{ all -> 0x006c }
            byte[] r9 = r9.digest()     // Catch:{ all -> 0x006c }
            int r1 = r9.length     // Catch:{ all -> 0x006c }
            int r3 = r8.f10087d     // Catch:{ all -> 0x006c }
            if (r1 <= r3) goto L_0x0034
            int r1 = r8.f10087d     // Catch:{ all -> 0x006c }
            goto L_0x0035
        L_0x0034:
            int r1 = r9.length     // Catch:{ all -> 0x006c }
        L_0x0035:
            ...
            int r9 = r8.f10088e     // Catch:{ all -> 0x006c }
            r3 = 8
            int r9 = r9 % r3
        ...
        L_0x0053:
            ...
            int r9 = 8 - r9
            long r4 = r4 >>> r9
            int r9 = r8.f10087d     // Catch:{ all -> 0x006c }
            int r9 = r9 + -1
        L_0x005d:
            if (r9 < 0) goto L_0x006a
        ...
        L_0x0070:
            goto L_0x006f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C1466coa.a(java.lang.String):byte[]");
    }
}
