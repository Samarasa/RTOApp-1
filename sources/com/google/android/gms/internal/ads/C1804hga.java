...
final class C1804hga extends C1591ega {
    C1804hga() {
    }
    ...
    public final int a(int r12, byte[] r13, int r14, int r15) {
        ...
        L_0x001f:
            ...
            int r12 = com.google.android.gms.internal.ads.C1521dga.b(r8, r14)
            return r12
        L_0x0032:
            r10 = r14
            r14 = r12
        ...
        L_0x0046:
            ...
            int r12 = com.google.android.gms.internal.ads.C1521dga.b(r8, r9)
            return r12
        L_0x0057:
            r14 = r12
            r12 = 0
        ...
        L_0x005d:
            ...
            int r12 = com.google.android.gms.internal.ads.C1521dga.b((int) r8, (int) r9, (int) r14)
            return r12
        L_0x006a:
            r10 = r14
            r14 = r12
        ...
        L_0x00a5:
            ...
            int r12 = com.google.android.gms.internal.ads.C1521dga.d(r13, r14, r15)
            return r12
        L_0x00b0:
            int r8 = r14 + 1
            byte r14 = r13[r14]
        ...
        L_0x00ea:
            ...
            goto L_0x008e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C1804hga.a(int, byte[], int, int):int");
    }
    ...
    public final int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                throw new C1733gga(i7 - 1, length);
            ...
            while (r13 < i3) {
                ...
                if (C1662fga.d(b3)) {
                    ...
                    while (i6 < i3) {
                        ...
                        i6++;
                        C1662fga.b(b4, cArr, i7);
                        i7++;
                    }
                    r13 = i6;
                    i5 = i7;
                } else if (C1662fga.e(b3)) {
                    if (i6 < i3) {
                        C1662fga.b(b3, bArr[i6], cArr, i5);
                        r13 = i6 + 1;
                        i5++;
                    } else {
                        throw Iea.i();
                    }
                } else if (C1662fga.f(b3)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        C1662fga.b(b3, bArr[i6], bArr[i8], cArr, i5);
                        r13 = i8 + 1;
                        i5++;
                    } else {
                        throw Iea.i();
                    ...
                    byte b5 = bArr[i6];
                    int i10 = i9 + 1;
                    C1662fga.b(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                    r13 = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw Iea.i();
