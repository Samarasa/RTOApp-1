...
public final class C1276aH {
    ...
    public static ArrayList<C2885wpa.a> a(SQLiteDatabase sQLiteDatabase) {
        ArrayList<C2885wpa.a> arrayList = new ArrayList<>();
        ...
        while (query.moveToNext()) {
            try {
                arrayList.add(C2885wpa.a.a(query.getBlob(query.getColumnIndexOrThrow("serialized_proto_data"))));
            } catch (Iea e2) {
                C1018Rk.b("Unable to deserialize proto from offline signals database:");
                C1018Rk.b(e2.getMessage());
            }
        }
        query.close();
        return arrayList;
