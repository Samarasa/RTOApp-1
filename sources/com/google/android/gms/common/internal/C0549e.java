...
public final class C0549e {
    ...
    private static final i<String, String> f5965a = new i<>();
    ...
    private static String a(Context context, String str) {
        synchronized (f5965a) {
            String str2 = f5965a.get(str);
            if (str2 != null) {
                return str2;
            }
            Resources c2 = c.b.b.b.b.i.c(context);
            if (c2 == null) {
                return null;
            }
            ...
            if (i == 3) {
                ...
                if (i == 9) {
                    ...
                    switch (i) {
                        ...
                        default:
                            return resources.getString(l.common_google_play_services_unknown_issue, new Object[]{a2});
                    }
                }
            }
        } else if (com.google.android.gms.common.util.i.d(context)) {
