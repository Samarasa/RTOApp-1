...
public final class C3133dd extends C3249zc {

    /* renamed from: c  reason: collision with root package name */
    private final SSLSocketFactory f13544c;

    C3133dd(C3144fc fcVar) {
        super(fcVar);
        this.f13544c = Build.VERSION.SDK_INT < 19 ? new ve() : null;
    }
    ...
    public final HttpURLConnection a(URL url) {
        ...
        if (openConnection instanceof HttpURLConnection) {
            SSLSocketFactory sSLSocketFactory = this.f13544c;
