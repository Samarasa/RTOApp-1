...
public class NestedScrollView extends FrameLayout implements n, j, s {
    ...
    private static final int[] f948b = {16843130};
    private float A;
    private b B;
    ...
    private OverScroller f951e;

    /* renamed from: f  reason: collision with root package name */
    private EdgeEffect f952f;

    /* renamed from: g  reason: collision with root package name */
    private EdgeEffect f953g;
    ...
    static class c extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f955a + "}";
        }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.u = new int[2];
        f();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f948b, i2, 0);
        setFillViewport(obtainStyledAttributes.getBoolean(0, false));
        obtainStyledAttributes.recycle();
        this.y = new p(this);
        this.z = new l(this);
        setNestedScrollingEnabled(true);
        y.a((View) this, (C0195a) f947a);
    }
    ...
    private void a(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.s) {
            ...
            this.f954h = (int) motionEvent.getY(i2);
    ...
    private boolean a(View view, int i2, int i3) {
        view.getDrawingRect(this.f950d);
        offsetDescendantRectToMyCoords(view, this.f950d);
        return this.f950d.bottom + i2 >= getScrollY() && this.f950d.top - i2 <= getScrollY() + i3;
    }
    ...
    private void b(int i2, int i3, boolean z2) {
        if (getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - this.f949c > 250) {
                View childAt = getChildAt(0);
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
                int height = childAt.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin;
                int height2 = (getHeight() - getPaddingTop()) - getPaddingBottom();
                int scrollY = getScrollY();
                OverScroller overScroller = this.f951e;
                int scrollX = getScrollX();
                overScroller.startScroll(scrollX, scrollY, 0, Math.max(0, Math.min(i3 + scrollY, Math.max(0, height - height2))) - scrollY);
                a(z2);
            } else {
                if (!this.f951e.isFinished()) {
                    a();
                }
                scrollBy(i2, i3);
            }
            this.f949c = AnimationUtils.currentAnimationTimeMillis();
        }
    }
    ...
    private void c() {
        ...
        h();
        f(0);
        EdgeEffect edgeEffect = this.f952f;
        if (edgeEffect != null) {
            edgeEffect.onRelease();
            this.f953g.onRelease();
        }
    }
    ...
    private void d() {
        if (getOverScrollMode() == 2) {
            this.f952f = null;
            this.f953g = null;
        } else if (this.f952f == null) {
            Context context = getContext();
            this.f952f = new EdgeEffect(context);
            this.f953g = new EdgeEffect(context);
        }
    }
    ...
    private void f() {
        this.f951e = new OverScroller(getContext());
        setFocusable(true);
    ...
    public boolean a(int i2) {
        ...
        if (findNextFocus == null || !a(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            findNextFocus.getDrawingRect(this.f950d);
            offsetDescendantRectToMyCoords(findNextFocus, this.f950d);
            g(a(this.f950d));
    ...
    public boolean a(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20, boolean r21) {
        ...
        L_0x005f:
            ...
            android.widget.OverScroller r3 = r0.f951e
            r8 = 0
            r9 = 0
            r10 = 0
    ...
    public void b(int i2) {
        if (getChildCount() > 0) {
            this.f951e.fling(getScrollX(), getScrollY(), 0, i2, 0, 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
            a(true);
        }
    }
    ...
    public boolean c(int i2) {
        ...
        boolean z2 = i2 == 130;
        int height = getHeight();
        Rect rect = this.f950d;
        rect.top = 0;
        rect.bottom = height;
        if (z2 && (childCount = getChildCount()) > 0) {
            View childAt = getChildAt(childCount - 1);
            this.f950d.bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
            Rect rect2 = this.f950d;
    ...
    public void computeScroll() {
        ...
        if (!this.f951e.isFinished()) {
            this.f951e.computeScrollOffset();
            int currY = this.f951e.getCurrY();
            int i2 = currY - this.w;
            this.w = currY;
            int[] iArr = this.u;
            boolean z2 = false;
            ...
            if (i3 != 0) {
                ...
                if (z2) {
                    d();
                    if (i3 < 0) {
                        if (this.f952f.isFinished()) {
                            edgeEffect = this.f952f;
                        }
                    } else if (this.f953g.isFinished()) {
                        edgeEffect = this.f953g;
                    }
                    edgeEffect.onAbsorb((int) this.f951e.getCurrVelocity());
                }
                a();
            }
            if (!this.f951e.isFinished()) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f952f != null) {
            ...
            if (!this.f952f.isFinished()) {
                ...
                this.f952f.setSize(width, height);
                if (this.f952f.draw(canvas)) {
                    y.E(this);
                }
                canvas.restoreToCount(save);
            }
            if (!this.f953g.isFinished()) {
                ...
                this.f953g.setSize(width2, height2);
                if (this.f953g.draw(canvas)) {
                    y.E(this);
                }
    ...
    public boolean e(int i2) {
        ...
        int height = getHeight();
        if (z2) {
            this.f950d.top = getScrollY() + height;
            int childCount = getChildCount();
            if (childCount > 0) {
                View childAt = getChildAt(childCount - 1);
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (i2 != 0) {
                ...
                if (i2 == 2) {
                    ...
                    if (i3 != -1) {
                        ...
                        if (findPointerIndex == -1) {
                            ...
                            if (Math.abs(y2 - this.f954h) > this.p && (2 & getNestedScrollAxes()) == 0) {
                                this.l = true;
                                this.f954h = y2;
                                g();
            ...
            this.s = -1;
            h();
            if (this.f951e.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                y.E(this);
            }
            f(0);
        } else {
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (!this.j) {
            if (this.x != null) {
                scrollTo(getScrollX(), this.x.f955a);
                this.x = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    public void onSizeChanged(int i2, int i3, int i4, int i5) {
        ...
        if (findFocus != null && this != findFocus && a(findFocus, 0, i5)) {
            findFocus.getDrawingRect(this.f950d);
            offsetDescendantRectToMyCoords(findFocus, this.f950d);
            g(a(this.f950d));
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0076, code lost:
        if (r10.f951e.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L_0x0078;
     */
    ...
    public boolean onTouchEvent(android.view.MotionEvent r24) {
        ...
        L_0x0054:
            ...
            if (r0 <= 0) goto L_0x007b
            android.widget.OverScroller r15 = r10.f951e
        ...
        L_0x0139:
            ...
            android.widget.EdgeEffect r1 = r10.f952f
            float r0 = (float) r0
            ...
            android.widget.EdgeEffect r0 = r10.f953g
        ...
        L_0x0192:
            ...
            android.widget.EdgeEffect r1 = r10.f953g
            float r0 = (float) r0
            int r2 = r23.getHeight()
            float r2 = (float) r2
            float r0 = r0 / r2
            ...
            float r2 = r2 - r3
            androidx.core.widget.d.a(r1, r0, r2)
            android.widget.EdgeEffect r0 = r10.f952f
            boolean r0 = r0.isFinished()
            if (r0 != 0) goto L_0x01ba
            android.widget.EdgeEffect r0 = r10.f952f
            goto L_0x018e
        ...
        L_0x0216:
            ...
            return r12
        L_0x021d:
            android.widget.OverScroller r0 = r10.f951e
            boolean r0 = r0.isFinished()
            r0 = r0 ^ r14
            r10.l = r0
