...
public class CoordinatorLayout extends ViewGroup implements m, n {
    ...
    static final String f818a;

    /* renamed from: b  reason: collision with root package name */
    static final Class<?>[] f819b = {Context.class, AttributeSet.class};

    /* renamed from: c  reason: collision with root package name */
    static final ThreadLocal<Map<String, Constructor<b>>> f820c = new ThreadLocal<>();

    /* renamed from: d  reason: collision with root package name */
    static final Comparator<View> f821d;

    /* renamed from: e  reason: collision with root package name */
    private static final b.h.i.d<Rect> f822e = new b.h.i.f(12);

    /* renamed from: f  reason: collision with root package name */
    private final List<View> f823f;

    /* renamed from: g  reason: collision with root package name */
    private final c<View> f824g;

    /* renamed from: h  reason: collision with root package name */
    private final List<View> f825h;
    ...
    public static class e extends ViewGroup.MarginLayoutParams {
        ...
        e(Context context, AttributeSet attributeSet) {
            ...
            this.f829c = obtainStyledAttributes.getInteger(b.g.c.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.f832f = obtainStyledAttributes.getResourceId(b.g.c.CoordinatorLayout_Layout_layout_anchor, -1);
            this.f830d = obtainStyledAttributes.getInteger(b.g.c.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.f831e = obtainStyledAttributes.getInteger(b.g.c.CoordinatorLayout_Layout_layout_keyline, -1);
            this.f833g = obtainStyledAttributes.getInt(b.g.c.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.f834h = obtainStyledAttributes.getInt(b.g.c.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.f828b = obtainStyledAttributes.hasValue(b.g.c.CoordinatorLayout_Layout_layout_behavior);
            if (this.f828b) {
                this.f827a = CoordinatorLayout.a(context, attributeSet, obtainStyledAttributes.getString(b.g.c.CoordinatorLayout_Layout_layout_behavior));
            }
        ...
        private void a(View view, CoordinatorLayout coordinatorLayout) {
            this.k = coordinatorLayout.findViewById(this.f832f);
            View view2 = this.k;
            if (view2 != null) {
                ...
                throw new IllegalStateException("Could not find CoordinatorLayout descendant view with id " + coordinatorLayout.getResources().getResourceName(this.f832f) + " to anchor view " + view);
            }
            this.l = null;
            this.k = null;
        }
        ...
        private boolean a(View view, int i2) {
            int a2 = C0197c.a(((e) view.getLayoutParams()).f833g, i2);
            return a2 != 0 && (C0197c.a(this.f834h, i2) & a2) == a2;
        }

        private boolean b(View view, CoordinatorLayout coordinatorLayout) {
            if (this.k.getId() != this.f832f) {
                return false;
            }
            View view2 = this.k;
        ...
        /* access modifiers changed from: package-private */
        public boolean a() {
            return this.k == null && this.f832f != -1;
        }
        ...
        public boolean a(androidx.coordinatorlayout.widget.CoordinatorLayout r2, android.view.View r3, android.view.View r4) {
            /*
                ...
                androidx.coordinatorlayout.widget.CoordinatorLayout$b r0 = r1.f827a
    ...
    protected static class g extends b.j.a.c {
        public static final Parcelable.Creator<g> CREATOR = new b();

        /* renamed from: c  reason: collision with root package name */
        SparseArray<Parcelable> f836c;
        ...
        public g(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f836c = new SparseArray<>(readInt);
            for (int i = 0; i < readInt; i++) {
                this.f836c.append(iArr[i], readParcelableArray[i]);
            }
        }
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            SparseArray<Parcelable> sparseArray = this.f836c;
            int size = sparseArray != null ? sparseArray.size() : 0;
            parcel.writeInt(size);
            int[] iArr = new int[size];
            Parcelable[] parcelableArr = new Parcelable[size];
            for (int i2 = 0; i2 < size; i2++) {
                iArr[i2] = this.f836c.keyAt(i2);
                parcelableArr[i2] = this.f836c.valueAt(i2);
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.v = obtainStyledAttributes.getDrawable(b.g.c.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        f();
    ...
    static b a(Context context, AttributeSet attributeSet, String str) {
        ...
        } else if (str.indexOf(46) < 0 && !TextUtils.isEmpty(f818a)) {
            str = f818a + '.' + str;
        }
        try {
            Map map = f820c.get();
            ...
            if (constructor == null) {
                constructor = context.getClassLoader().loadClass(str).getConstructor(f819b);
    ...
    private void a(View view, int i2, Rect rect, Rect rect2, e eVar, int i3, int i4) {
        int a2 = C0197c.a(c(eVar.f829c), i2);
        int a3 = C0197c.a(d(eVar.f830d), i2);
        int i5 = a2 & 7;
        int i6 = a2 & 112;
        int i7 = a3 & 7;
        int i8 = a3 & 112;
    ...
    private void a(List<View> list) {
        ...
        Comparator<View> comparator = f821d;
        if (comparator != null) {
    ...
    private void b(View view, int i2, int i3) {
        e eVar = (e) view.getLayoutParams();
        int a2 = C0197c.a(e(eVar.f829c), i3);
        int i4 = a2 & 7;
        int i5 = a2 & 112;
        int width = getWidth();
        int height = getHeight();
    ...
    private void d(View view, int i2) {
        ...
        Rect d3 = d();
        C0197c.a(d(eVar.f829c), view.getMeasuredWidth(), view.getMeasuredHeight(), d2, d3, i2);
        view.layout(d3.left, d3.top, d3.right, d3.bottom);
        a(d2);
        a(d3);
    }
    ...
    private void e() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            e d2 = d(childAt);
            d2.a(this, childAt);
            this.f824g.a(childAt);
            for (int i3 = 0; i3 < childCount; i3++) {
                if (i3 != i2) {
                    View childAt2 = getChildAt(i3);
                    if (d2.a(this, childAt, childAt2)) {
                        if (!this.f824g.b(childAt2)) {
                            this.f824g.a(childAt2);
                        }
                        this.f824g.a(childAt2, childAt);
                    }
                }
            }
        }
        this.f823f.addAll(this.f824g.b());
        Collections.reverse(this.f823f);
    }
    ...
    public final void a(int i2) {
        ...
        Rect d4 = d();
        for (int i4 = 0; i4 < size; i4++) {
            View view = this.f823f.get(i4);
            e eVar = (e) view.getLayoutParams();
            if (i3 != 0 || view.getVisibility() != 8) {
                for (int i5 = 0; i5 < i4; i5++) {
                    if (eVar.l == this.f823f.get(i5)) {
                        b(view, m2);
                    }
                }
                a(view, true, d3);
                if (eVar.f833g != 0 && !d3.isEmpty()) {
                    int a2 = C0197c.a(eVar.f833g, m2);
                    int i6 = a2 & 112;
                    if (i6 == 48) {
                ...
                if (eVar.f834h != 0 && view.getVisibility() == 0) {
                    a(view, d2, m2);
                }
                if (i3 != 2) {
                    b(view, d4);
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (eVar.a(i6) && (d2 = eVar.d()) != null) {
                    ...
                    i7 = i4 > 0 ? Math.max(i7, this.k[0]) : Math.min(i7, this.k[0]);
                    i8 = i5 > 0 ? Math.max(i8, this.k[1]) : Math.min(i8, this.k[1]);
                    z = true;
                }
            }
        }
    ...
    public List<View> b(View view) {
        List<View> d2 = this.f824g.d(view);
        this.i.clear();
        if (d2 != null) {
            this.i.addAll(d2);
        }
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (bVar != null) {
            ...
            if (c2 > 0.0f) {
                ...
                this.j.setColor(eVar.f827a.b(this, view));
    ...
    public final List<View> getDependencySortedChildren() {
        e();
        return Collections.unmodifiableList(this.f823f);
    }
    ...
    public void onMeasure(int r31, int r32) {
        ...
        L_0x004b:
            r19 = 0
        L_0x004d:
            java.util.List<android.view.View> r2 = r7.f823f
            int r6 = r2.size()
            r4 = r0
            r2 = r1
            r3 = 0
        ...
        L_0x0057:
            ...
            java.util.List<android.view.View> r0 = r7.f823f
        ...
        L_0x0071:
            ...
            int r11 = r1.f829c
            int r11 = e((int) r11)
            int r11 = b.h.j.C0197c.a(r11, r10)
            r11 = r11 & 7
            r22 = r2
            r2 = 3
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = gVar.f836c;
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
    ...
    public void setStatusBarBackgroundResource(int i2) {
        setStatusBarBackground(i2 != 0 ? b.h.a.a.c(getContext(), i2) : null);
    }
