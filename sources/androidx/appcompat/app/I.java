...
class I {
    ...
    public void a(long j, double d2, double d3) {
        ...
        if (sin3 >= 1.0d) {
            ...
            Double.isNaN(acos);
            this.f157b = Math.round((sin2 + acos) * 8.64E7d) + 946728000000L;
            Double.isNaN(acos);
            this.f158c = Math.round((sin2 - acos) * 8.64E7d) + 946728000000L;
            if (this.f158c >= j || this.f157b <= j) {
                this.f159d = 1;
                return;
            } else {
                this.f159d = 0;
