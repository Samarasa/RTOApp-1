...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f419a = obtainStyledAttributes.getBoolean(j.ButtonBarLayout_allowStacking, true);
    ...
    public int getMinimumHeight() {
        return Math.max(this.f421c, super.getMinimumHeight());
    }
    ...
    public void setAllowStacking(boolean z) {
        if (this.f419a != z) {
            this.f419a = z;
            if (!this.f419a && getOrientation() == 1) {
                setStacked(false);
            }
            requestLayout();
        }
