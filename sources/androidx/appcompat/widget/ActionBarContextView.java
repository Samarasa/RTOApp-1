...
public class ActionBarContextView extends C0110a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i2) {
        ...
        Aa a2 = Aa.a(context, attributeSet, j.ActionMode, i2, 0);
        y.a((View) this, a2.b(j.ActionMode_background));
        this.p = a2.g(j.ActionMode_titleTextStyle, 0);
        this.q = a2.g(j.ActionMode_subtitleTextStyle, 0);
        this.f593e = a2.f(j.ActionMode_height, 0);
    ...
    public /* bridge */ /* synthetic */ E a(int i2, long j2) {
    ...
    public void a(b.a.d.b r4) {
        ...
        L_0x0022:
            ...
            androidx.appcompat.view.menu.k r4 = (androidx.appcompat.view.menu.k) r4
            androidx.appcompat.widget.g r0 = r3.f592d
        ...
        L_0x003f:
            ...
            r2 = -1
            r0.<init>(r1, r2)
            androidx.appcompat.widget.g r1 = r3.f592d
            android.content.Context r2 = r3.f590b
            r4.a((androidx.appcompat.view.menu.t) r1, (android.content.Context) r2)
            androidx.appcompat.widget.g r4 = r3.f592d
            androidx.appcompat.view.menu.u r4 = r4.b((android.view.ViewGroup) r3)
            androidx.appcompat.widget.ActionMenuView r4 = (androidx.appcompat.widget.ActionMenuView) r4
            r3.f591c = r4
            androidx.appcompat.widget.ActionMenuView r4 = r3.f591c
            r1 = 0
            b.h.j.y.a((android.view.View) r4, (android.graphics.drawable.Drawable) r1)
            androidx.appcompat.widget.ActionMenuView r4 = r3.f591c
            r3.addView(r4, r0)
            return
        */
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (view == null || view.getVisibility() == 8) {
            ...
            int a3 = C0110a.a(paddingRight, i7, a2);
            i6 = C0110a.a(a3 + a(this.k, a3, paddingTop, paddingTop2, a2), i8, a2);
        }
        LinearLayout linearLayout = this.m;
        ...
        ActionMenuView actionMenuView = this.f591c;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) != 1073741824) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = a(this.f591c, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.m;
