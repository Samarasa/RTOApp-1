...
abstract class h<K, V> {
    ...
    final class a<T> implements Iterator<T> {
        ...
        a(int i) {
            this.f2224a = i;
            this.f2225b = h.this.c();
        }

        public boolean hasNext() {
            return this.f2226c < this.f2225b;
        }

        public T next() {
            if (hasNext()) {
                T a2 = h.this.a(this.f2226c, this.f2224a);
                this.f2226c++;
                this.f2227d = true;
                return a2;
            }
    ...
    final class d implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            if (!this.f2233c) {
                ...
                Map.Entry entry = (Map.Entry) obj;
                return e.a(entry.getKey(), h.this.a(this.f2232b, 0)) && e.a(entry.getValue(), h.this.a(this.f2232b, 1));
            }
        }

        public K getKey() {
            if (this.f2233c) {
                return h.this.a(this.f2232b, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public int hashCode() {
            if (this.f2233c) {
                int i = 0;
                Object a2 = h.this.a(this.f2232b, 0);
                Object a3 = h.this.a(this.f2232b, 1);
