...
public class k {
    ...
    private Handler.Callback f2463e = new g(this);
    ...
    private void b(Runnable runnable) {
        synchronized (this.f2459a) {
            if (this.f2460b == null) {
                this.f2460b = new HandlerThread(this.f2466h, this.f2465g);
                this.f2460b.start();
                this.f2461c = new Handler(this.f2460b.getLooper(), this.f2463e);
                this.f2462d++;
            }
            this.f2461c.removeMessages(0);
            this.f2461c.sendMessage(this.f2461c.obtainMessage(1, runnable));
        }
    }
    ...
    public <T> T a(java.util.concurrent.Callable<T> r13, int r14) {
        ...
        L_0x0062:
            goto L_0x0061
        */
        throw new UnsupportedOperationException("Method not decompiled: b.h.g.k.a(java.util.concurrent.Callable, int):java.lang.Object");
    }

    /* access modifiers changed from: package-private */
    public void a() {
        synchronized (this.f2459a) {
            if (!this.f2461c.hasMessages(1)) {
                this.f2460b.quit();
                this.f2460b = null;
                this.f2461c = null;
            }
    ...
    public void a(Runnable runnable) {
        ...
        synchronized (this.f2459a) {
            this.f2461c.removeMessages(0);
            this.f2461c.sendMessageDelayed(this.f2461c.obtainMessage(0), (long) this.f2464f);
        }
    }
