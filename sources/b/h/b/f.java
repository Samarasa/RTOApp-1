...
public class f extends d {
    ...
    protected final Class<?> f2409g;

    /* renamed from: h  reason: collision with root package name */
    protected final Constructor<?> f2410h;
    ...
    private Object d() {
        try {
            return this.f2410h.newInstance(new Object[0]);
    ...
    public Typeface a(Context context, Resources resources, int i2, String str, int i3) {
        ...
        if (!a(context, d2, str, 0, -1, -1, (FontVariationAxis[]) null)) {
            b(d2);
            return null;
        } else if (!c(d2)) {
            return null;
    ...
    public android.graphics.Typeface a(android.content.Context r12, android.os.CancellationSignal r13, b.h.g.f.b[] r14, int r15) {
        /*
            r11 = this;
            int r0 = r14.length
            r1 = 1
        ...
        L_0x0006:
            ...
            b.h.g.f$b r14 = r11.a((b.h.g.f.b[]) r14, (int) r15)
        ...
        L_0x0063:
            return r2
        L_0x0064:
            java.util.Map r12 = b.h.g.f.a((android.content.Context) r12, (b.h.g.f.b[]) r14, (android.os.CancellationSignal) r13)
        ...
        L_0x00b3:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: b.h.b.f.a(android.content.Context, android.os.CancellationSignal, b.h.g.f$b[], int):android.graphics.Typeface");
    }
    ...
    public Typeface a(Object obj) {
        try {
            Object newInstance = Array.newInstance(this.f2409g, 1);
